<%-- 
    Document   : UpdateSubjectDetails
    Created on : 19 Dec, 2019, 8:58:59 AM
    Author     : vinay
--%>
...
<html>
    ...
    <body>
        ...
        <div class="row center-form">
            <div class="col-sm-7">
                <f:form class="form-controller1" action="../updSubjDetails" method="POST" modelAttribute="subject">
                    <h1 class="text-white title-h1 " style="color: white;">Subject Update</h1>
                    <f:input type="hidden" class="form-control input-sm" path="sub_id" id="contact"
